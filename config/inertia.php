...
return [
    ...
    |
    | In production a dedicated Node SSR sidecar runs `node bootstrap/ssr/ssr.js`
    | (Railway service `sky-amman-ssr`, private port 13714). The main app reaches
    | it via INERTIA_SSR_URL. Locally SSR is OFF by default (CSR only) — opt in
    | with INERTIA_SSR_ENABLED=true + `php artisan inertia:start-ssr`.
    |
    */
    ...
    'ssr' => [
        ...
        // Read by App\Ssr\TimeoutHttpGateway.
