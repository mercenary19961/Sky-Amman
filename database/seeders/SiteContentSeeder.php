...
class SiteContentSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            ['home', 'assurance_financial', 'title', 'Financial Assurance', 'الضمان المالي'],
            ['home', 'assurance_financial', 'bullet_1', 'Contracts are drafted and verified by a dedicated legal department', 'تتم صياغة العقود والتحقق منها من قبل دائرة قانونية متخصصة'],
            ['home', 'assurance_financial', 'bullet_2', 'All payments are officially documented', 'جميع المدفوعات موثّقة رسمياً'],
            ['home', 'assurance_financial', 'bullet_3', 'Full support through the property registration process', 'دعم كامل خلال إجراءات تسجيل العقار'],
            ['home', 'assurance_financial', 'bullet_4', 'Legal verification of land ownership before project initiation', 'التحقق القانوني من ملكية الأرض قبل بدء المشروع'],

            ['home', 'assurance_legal', 'number', '002', '002'],
            ['home', 'assurance_legal', 'title', 'Legal Assurance', 'الضمان القانوني'],
            ['home', 'assurance_legal', 'bullet_1', 'Client payments are protected until ownership registration', 'مدفوعات العميل محمية حتى تسجيل الملكية'],
            ['home', 'assurance_legal', 'bullet_2', 'Flexible financing solutions through banking partners', 'حلول تمويل مرنة عبر شركاء مصرفيين'],
            ['home', 'assurance_legal', 'bullet_3', 'Full transparency in pricing and payment schedules', 'شفافية كاملة في الأسعار وجداول الدفع'],
            ['home', 'assurance_legal', 'bullet_4', 'No hidden costs or unexpected obligations', 'لا توجد تكاليف خفية أو التزامات غير متوقعة'],

            ['home', 'assurance_safety', 'number', '003', '003'],
            ['home', 'assurance_safety', 'title', 'Construction Safety & Quality', 'سلامة وجودة البناء'],
            ['home', 'assurance_safety', 'bullet_1', 'Projects executed under certified engineering supervision', 'تنفيذ المشاريع تحت إشراف هندسي معتمد'],
            ['home', 'assurance_safety', 'bullet_2', 'Approved execution partners recognized by official authorities', 'شركاء تنفيذ معتمدون من الجهات الرسمية'],
            ['home', 'assurance_safety', 'bullet_3', 'Strict adherence to technical specifications', 'الالتزام الصارم بالمواصفات الفنية'],
            ['home', 'assurance_safety', 'bullet_4', 'Use of trusted and verified suppliers', 'استخدام موردين موثوقين ومعتمدين'],

            ['home', 'secure_cta', 'title', 'Secure Investment', 'استثمار آمن'],
