 ...
 * SSR sidecar (the `sky-amman-ssr` Railway service).
 *
 ...
 *
 * This mirrors the parent's (inertia-laravel v3) `dispatch()` logic verbatim —
 * SSR-enabled guard, Vite hot handling, bundle-existence check, failure
 * handling — and only adds the timeouts to the outgoing HTTP calls.
 */
