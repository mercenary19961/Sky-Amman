// Brand SVGs — lucide-react v1 dropped trademarked icons, so we ship our own.
// Each icon is a 24x24 currentColor path so it inherits text color.
...
export function TwitterIcon({ size = 20, className }: IconProps) {
    return (
        <svg {...baseProps(size)} className={className}>
            <path d="M18.9 1.5h3.68l-8.04 9.19L24 22.5h-7.4l-5.8-7.58-6.63 7.58H.49l8.6-9.83L0 1.5h7.59l5.24 6.93L18.9 1.5zm-1.29 18.8h2.04L6.49 3.6H4.3l13.31 16.7z" />
        </svg>
    );
}
...
export function YoutubeIcon({ size = 20, className }: IconProps) {
    return (
        <svg {...baseProps(size)} className={className}>
            <path d="M23.5 6.2a3 3 0 00-2.1-2.13C19.55 3.57 12 3.57 12 3.57s-7.55 0-9.4.5A3 3 0 00.5 6.2C0 8.05 0 12 0 12s0 3.95.5 5.8a3 3 0 002.1 2.13c1.85.5 9.4.5 9.4.5s7.55 0 9.4-.5a3 3 0 002.1-2.13c.5-1.85.5-5.8.5-5.8s0-3.95-.5-5.8zM9.6 15.57V8.43L15.82 12 9.6 15.57z" />
        </svg>
    );
}
...
export function TiktokIcon({ size = 20, className }: IconProps) {
    return (
        <svg {...baseProps(size)} className={className}>
            <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.9 2.9 0 01-2.9 2.9 2.9 2.9 0 01-2.9-2.9 2.9 2.9 0 012.9-2.9c.3 0 .58.05.85.13V9.4a6.34 6.34 0 00-.85-.06 6.35 6.35 0 100 12.7 6.35 6.35 0 006.35-6.35V8.66a8.27 8.27 0 004.83 1.55V6.74a4.79 4.79 0 01-1.06.05z" />
        </svg>
    );
}
