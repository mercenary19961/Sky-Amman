...
/**
 * Floating WhatsApp contact button (bottom-right on every public page), ported
 * from the Nuor/HardRock build. The number comes from the editable `company_phone`
 * setting — digits only, since wa.me wants no "+", spaces, or leading zeros (our
 * default is already the international "+962 7…" form). Hidden if no phone is set.
 */
