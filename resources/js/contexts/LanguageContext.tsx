...
export function LanguageProvider({ children }: { children: ReactNode }) {
    ...
    // user's choice. The session cookie is the single source of truth — no
    ...
    const syncLocale = (lang: Language) => {
        // Update the server session without triggering an Inertia visit.
        // Laravel reads the XSRF-TOKEN cookie automatically.
